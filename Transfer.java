  ...
  public void removeItems(int listNumber) {
    ...
    */
    ...
    if(listNumber == 1) { // Food
      ...
      */  
      int indexOfPart = partsInventory.searchByName(partsList, name);
      System.out.println("Removing " + name + " at index " + indexOfPart);
      partsList.remove(indexOfPart);
      ...
      */
      int indexOfSupplies = suppliesInventory.searchByName(suppliesList, name);
      System.out.println("Removing " + name + " at index " + indexOfSupplies);
      suppliesList.remove(indexOfSupplies);
  ...
  public void editQuantity(int listNumber) {
    ...
    */
    ...
    if(listNumber == 1) { // Food
      ...
      *  for our partsList.
      */
      Parts partsNum = partsInventory.checkQty(partsList, name, desiredQty);
      ...
      */
      Supplies supplyName = suppliesInventory.checkQty(suppliesList, name, desiredQty);
